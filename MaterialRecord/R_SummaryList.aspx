<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="R_SummaryList.aspx.cs" Inherits="MaterialRecord.R_SummaryList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:Label ID="lbl_sum" runat="server" Text="資料總筆數：0" CssClass="message" Font-Size="20px" ForeColor="Black"></asp:Label>
                ...
                <LayoutTemplate>
                    <table runat="server" id="itemPlaceholderContainer" style="" border="0" class="table table-striped">
                        <tr runat="server">
                            ...
                            <th runat="server" style="width: 20%">名稱</th>
                            ...
                            <th runat="server" style="width: 7%">報廢日</th>
                            <th runat="server" style="width: 21%">備註</th>
                        </tr>
