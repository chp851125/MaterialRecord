<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="R_Record.aspx.cs" Inherits="MaterialRecord.R_Record" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <div class="form-row">
                ...
                <%--<div class="col-1">
                    <asp:Label ID="lbl_type" runat="server" Text="類別" CssClass="querytext"></asp:Label>
                    <asp:DropDownList ID="ddl_type" runat="server" CssClass="queryDropdownlist" Width="70%"></asp:DropDownList>
                </div>--%>
                <div class="col-8 row">
                    <div>
                        <asp:Label ID="lbl_dateRange" runat="server" Text="日期區間" CssClass="querytext"></asp:Label>
                        <asp:DropDownList ID="ddl_dateType" runat="server" CssClass="queryDropdownlist" Width="50%"></asp:DropDownList>&nbsp
                    </div>
                    <div>
                    ...
                    <div>
                        <asp:TextBox ID="txt_condition" runat="server" class="form-control" placeholder="編號、名稱" OnTextChanged="btn_query_Click" AutoPostBack="true" width="90%"></asp:TextBox>
                    </div>
                    <div>
                ...
                <%--<div class="col-2">
                    <asp:Label ID="lbl_sum" runat="server" Text="資料總筆數：0" CssClass="message" Font-Size="20px"></asp:Label>
                </div>--%>
                <div class="col-1" >
            ...
            <br />
            <asp:Label ID="lbl_sum" runat="server" Text="總使用次數：0" CssClass="message" Font-Size="20px" ForeColor="Black"></asp:Label>
            <asp:ListView ID="ListView1" runat="server" OnPagePropertiesChanged="ListView1_PagePropertiesChanged">
                ...
                <ItemTemplate>
                    <tr style="" class="trOnHoverItemTemplate" id='<%#Container.DataItemIndex + 1 %>'>
                        <td style="text-align: center">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    <asp:LinkButton ID="lbtn_history" runat="server" Text="使用紀錄" CssClass="dropdown-item edit" CausesValidation="False" CommandArgument='<%# Eval("ID") %>' OnCommand="lbtn_history_Command" />
                                </div>
                            </div>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:Label Text='<%# Eval("TotalCount") %>' runat="server" ID="TotalCountLabel" /></td>
                    </tr>
                </ItemTemplate>
                <LayoutTemplate>
                    <table runat="server" id="itemPlaceholderContainer" style="" border="0" class="table table-striped">
                        <tr runat="server">
                            ...
                            <th runat="server" style="width: 9%">可使用次數</th>
                            ...
                            <th runat="server" style="width: 14%">備註</th>
                            <th runat="server" style="width: 7%">使用次數</th>
                        </tr>
                    ...
                    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable" role="document" style="max-width: 80%;">
                        <div class="modal-content">
                            <div class="modal-header">
                                <asp:Label ID="lbl_historyModalTitle" CssClass="modal-title" runat="server" Text="使用紀錄" ForeColor="Black" Width="100%"></asp:Label>
