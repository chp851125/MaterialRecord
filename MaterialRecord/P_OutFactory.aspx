<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="P_OutFactory.aspx.cs" Inherits="MaterialRecord.P_OutFactory" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function hideHintDiv() {
            ...
            $('#div_refNumber').attr('style', 'display:none');
            $('#div_remark').attr('style', 'display:none');
        };

        function hideRecyclingDiv() {
            $('#div_recycling').attr('style', 'display:none');
        };

        function hideRefNumberDiv() {
            $('#div_refNumber').attr('style', 'display:none');
        };
        ...
        function autoFactory() {
            ...
            if (mode === 'true') {
                document.getElementById('ContentPlaceHolder1_btn_outFactory').click();
            }
        };
            ...
            <div class="form-row">
                ...
                <div class="col-7" style="text-align: right;">
                    <div class="custom-control custom-switch" style="display:inline-block;text-align:right">
                        ...
                        <label class="custom-control-label" for="customSwitches">自動出廠模式</label>
                    </div>
                    &nbsp&nbsp
                    <asp:Button ID="btn_code" runat="server" Text="掃描條碼" class="btn btn-primary" OnClick="btn_code_Click" />&nbsp&nbsp
                    <%--<asp:Button ID="btn_outFactory" runat="server" Text="出廠" class="btn btn-primary" OnClick="btn_outFactory_Click" />&nbsp&nbsp--%>
                    <asp:Button ID="btn_cancelFactory" runat="server" Text="取消出廠" class="btn btn-primary" OnClick="btn_cancelFactory_Click" />&nbsp&nbsp
                    <asp:Button ID="btn_scrap" runat="server" Text="報廢" class="btn btn-primary" OnClick="btn_scrap_Click" />&nbsp&nbsp
                    <asp:Button ID="btn_edit" runat="server" Text="可使用次數維護" class="btn btn-primary" OnClick="btn_edit_Click" />&nbsp&nbsp
                </div>
            </div>
            <br />
            <asp:Button ID="btn_outFactory" runat="server" Text="出廠" class="btn btn-primary" OnClick="btn_outFactory_Click" Width="33%" />&nbsp&nbsp
            <br />
            <br />
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group row" id="div_refNumber">
                                    <label for="lbl_RefNumber" class="col-sm-4 col-form-label">參考單號</label>
                                    <div class="col-sm-8">
                                        <asp:TextBox ID="txt_RefNumber" runat="server" class="form-control"></asp:TextBox>
                                    </div>
                                </div>
